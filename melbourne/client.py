...
from platform_ import Platform  # don't clobber the builtin platform
from direction import Direction
from stop import StopFactory
from line import LineFactory
from run import RunFactory
from outlet import OutletFactory
from disruption import DisruptionFactory
...
class PTVClient(object):
    ...
    def __init__(self, developer_id=None, api_key=None):
        ...
        self.departureTime = datetime.utcnow().replace(microsecond=0).isoformat() + 'Z'
    ...
    def _api_request(self, api_path):
        ...
        query.append(('timestamp', self.get_time()))
